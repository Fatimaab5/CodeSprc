		...
		<!--News Ticker js-->
		<script src="{{URL::asset('assets/plugins/newsticker/breaking-news-ticker.min-rtl.js')}}"></script>
		...
		<script src="{{URL::asset('assets/plugins/pscrollbar/p-scrollbar-leftmenu-rtl.js')}}"></script>
