				...
				<aside class="app-sidebar toggle-sidebar">
					<div class="app-sidebar__user">
						...
						<div class="user-info">
							<a href="#" class=""><span class="app-sidebar__user-name font-weight-semibold">Alison</span><br>
					...
					<ul class="side-menu toggle-menu">
						<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-device-desktop"></i><span class="side-menu__label active">Home</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon ti-layout"></i><span class="side-menu__label">Layouts</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
								<li class="sub-slide">
									<a href="#" data-toggle="sub-slide" class="sub-slide-item"><span class="sub-side-menu__label">Horizontal Versions</span><i class="sub-angle fa fa-angle-left"></i></a>
								...
								<li class="sub-slide">
									<a href="#" data-toggle="sub-slide" class="sub-slide-item"><span class="sub-side-menu__label">Vertical Versions</span><i class="sub-angle fa fa-angle-left"></i></a>
									<ul class="sub-slide-menu">
										<li class="sub-slide2">
											<a href="#" data-toggle="sub-slide2" class="sub-slide-item2"><span class="sub-side-menu__label">Vertical-Menu</span><i class="sub-angle2 fa fa-angle-left"></i> </a>
										...
										<li class="sub-slide2">
											<a href="#" data-toggle="sub-slide2" class="sub-slide-item2"><span class="sub-side-menu__label">Closed-Sidebar</span><i class="sub-angle2 fa fa-angle-left"></i> </a>
											<ul class="sub-slide-menu2">
										...
										<li class="sub-slide2">
											<a href="#" data-toggle="sub-slide2" class="sub-slide-item2"><span class="sub-side-menu__label">Toggle-sidebar</span><i class="sub-angle2 fa fa-angle-left"></i> </a>
											<ul class="sub-slide-menu2">
										...
										<li class="sub-slide2">
											<a href="#" data-toggle="sub-slide2" class="sub-slide-item2"><span class="sub-side-menu__label">Combined-Menu</span><i class="sub-angle2 fa fa-angle-left"></i> </a>
											<ul class="sub-slide-menu2">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-th-large-outline"></i><span class="side-menu__label">Apps</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-chart-pie-outline"></i><span class="side-menu__label">Charts</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-spanner-outline"></i><span class="side-menu__label">Elements</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-briefcase"></i><span class="side-menu__label">Advanced UI</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-document"></i><span class="side-menu__label"> Forms</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-point-of-interest-outline"></i><span class="side-menu__label">Icons</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-calendar-outline"></i><span class="side-menu__label">Calendar</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-clipboard"></i><span class="side-menu__label">Tables</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-cog-outline"></i><span class="side-menu__label">Pages</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-shopping-cart"></i><span class="side-menu__label">E-Commerce</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-download-outline"></i><span class="side-menu__label">Custom</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon typcn typcn-info-outline"></i><span class="side-menu__label">Errors</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon bx bx-minus-front typcn-info-outline"></i><span class="side-menu__label">Submenus</span><i class="angle fa fa-angle-left"></i></a>
							<ul class="slide-menu">
								<li><a href="#" class="slide-item">Submenu 1</a></li>
								<li class="sub-slide">
									<a href="#" data-toggle="sub-slide" class="sub-slide-item"><span class="sub-side-menu__label">Submenu 2</span><i class="sub-angle fa fa-angle-left"></i></a>
										<ul class="sub-slide-menu">
											<li><a href="#" class="sub-slide-item">Submenu 2.1</a></li>
											<li class="sub-slide2">
												<a href="#" data-toggle="sub-slide2" class="sub-slide-item2"><span class="sub-side-menu__label2"> Submenu 2.2</span><i class="sub-angle2 fa fa-angle-left"></i> </a>
												<ul class="sub-slide-menu2">
