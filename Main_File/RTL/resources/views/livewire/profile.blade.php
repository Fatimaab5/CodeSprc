										...
										<div class="card-body">
											<div class="nav-wrapper p-0">
												<ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
													<li class="nav-item">
														<a class="nav-link mb-sm-3 mb-md-0 mt-md-2 mt-0 mt-lg-0 active show" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true"><i class="fa fa-home ml-2"></i>About</a>
													</li>
													<li class="nav-item">
														<a class="nav-link mb-sm-3 mb-md-0 mt-md-2 mt-0 mt-lg-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><i class="fa fa-user ml-2"></i>Friends</a>
													</li>
													<li class="nav-item">
														<a class="nav-link mb-sm-3 mb-md-0 mt-md-2 mt-0 mt-lg-0" id="tabs-icons-text-3-tab" data-toggle="tab" href="#tabs-icons-text-3" role="tab" aria-controls="tabs-icons-text-3" aria-selected="false"><i class="fa fa-picture-o ml-2"></i>Photos</a>
													</li>
													<li class="nav-item">
														<a class="nav-link mb-sm-3 mb-md-0 mt-md-2 mt-0 mt-lg-0" id="tabs-icons-text-4-tab" data-toggle="tab" href="#tabs-icons-text-4" role="tab" aria-controls="tabs-icons-text-4" aria-selected="false"><i class="fa fa-newspaper-o ml-2 mt-1"></i>Timeline</a>
													</li>
													<li class="nav-item">
														<a class="nav-link mb-sm-0 mb-md-0 mt-md-2 mt-0 mt-lg-0" id="tabs-icons-text-5-tab" data-toggle="tab" href="#tabs-icons-text-5" role="tab" aria-controls="tabs-icons-text-5" aria-selected="false"><i class="fa fa-cog ml-2"></i>More</a>
													</li>
												</ul>
											</div>
										</div>
																				...
																				<div class="col-xl-6">
																					<div class="mb-2 border">
																						<div class="media overflow-visible">
																							...
																							<div class="media-body valign-middle text-left overflow-visible">
															...
															<div class="card">
																<form class="mt ng-pristine ng-valid" action="#">
																	...
																	<div class="btn-toolbar">
																		<div class=""><a href="#" class="btn btn-sm btn-primary ml-2"><i class="fa fa-camera fa-lg"></i></a> <a href="#" class="btn btn-sm btn-info"><i class="fa fa-map-marker fa-lg"></i></a>
																		</div>
																		<button  class="btn btn-danger btn-sm mr-3">Post</button>
																	</div>
																</form>
															</div>
																...
																<div class="d-flex">
																	...
																	<div>
																		<div class="clearfix border-top post-comments">
																			<ul class="post-links mt-sm pull-right p-2">
																				<li><a href="#">1 hour</a>
																				</li>
																		...
																		<ul class="post-comments mt-sm mb-0">
																			...
																			<li><span class="thumb-sm float-right ml-sm ml-4" ><img class="avatar avatar-md brround" src="{{URL::asset('assets/images/users/male/33.jpg')}}" alt="..."></span>
