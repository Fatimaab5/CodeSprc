											...
											<div class="col-xl-6">
												...
												<div class="form-group">
													...
													<div class="input-group file-browser">
														<input type="text" class="form-control border-left-0 browse-file" placeholder="Upload Images" readonly>
									...
									<div class=" card-body">
										...
										<div class="d-flex">
											<div class="input-group wd-150">
												...
												<button class="btn btn btn-primary btn-square" id="setTimeButton">Set Current Time</button>
											</div><!-- input-group -->
										</div>
									</div>
								</div>
