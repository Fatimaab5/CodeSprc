								...
								<div class="card card-img-holder">
									<div class="card-body">
										<div class="clearfix">
											...
											<div class="float-left text-right mt-2">
												...
												<div class="card-body mt-4">
													<div class="d-flex  align-items-center">
														<div><h4 class="font-medium ml-3">10%</h4>
															<h4 class="mb-0"><span class="text-primary"><i class="fa fa-plus ml-2"></i>Positive</span></h4>
														</div>
														<div class="mr-auto">
															<h4 class="font-medium ml-3">20%</h4>
															<h4 class=" mb-0"><span class="text-danger"><i class="fa fa-minus ml-2"></i> Negative</span></h4>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="{{URL::asset('assets/images/users/female/1.jpg')}}" alt="Generic placeholder image" class="avatar brround avatar-md ml-3">
											</figure>
											<div class="media-body">
												<h5 class="time-title p-0 mb-0 font-weight-semibold leading-normal">Victoria</h5>
												New york, UK
											</div>
											<button class="btn btn-primary d-none d-sm-block ml-2"><i class="fa fa-comments"></i> </button>
							...
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="{{URL::asset('assets/images/users/male/18.jpg')}}" alt="Generic placeholder image" class="avatar brround avatar-md ml-3">
											</figure>
											<div class="media-body">
							...
							<div class="col-lg-12 col-xl-4 col-sm-12">
								<div class="card mb-5">
									<div class="card-body">
										<div class="media mt-0">
											<figure class="rounded-circle align-self-start mb-0">
												<img src="{{URL::asset('assets/images/users/female/18.jpg')}}" alt="Generic placeholder image" class="avatar brround avatar-md ml-3">
											</figure>
											<div class="media-body">
										...
										<div class="list-group projects-list">
											...
											<a href="#" class="list-group-item list-group-item-action flex-column align-items-start br-br-7 br-bl-7">
												<div class="d-flex w-100 justify-content-between">
													...
													<small class="text-success"><i class="fa fa-caret-up ml-1"></i>10 days ago</small>
												</div>
									...
									<div class="card-body p-0 ">
										<div class="list-group list-lg-group list-group-flush">
											<a class="list-group-item list-group-item-action" href="#">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle ml-3" src="{{URL::asset('assets/images/users/female/2.jpg')}}" alt="Image description">
													<div class="media-body">
											...
											<a class="list-group-item list-group-item-action" href="#">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle ml-3" src="{{URL::asset('assets/images/users/male/2.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-1">
																Kevin North
											...
											<a class="list-group-item list-group-item-action" href="#">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle ml-3" src="{{URL::asset('assets/images/users/male/12.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-1">
																Steven Fisher
											...
											<a class="list-group-item list-group-item-action br-br-7 br-bl-7" href="#">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle ml-3" src="{{URL::asset('assets/images/users/female/5.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-1">
																Joanne Taylor
