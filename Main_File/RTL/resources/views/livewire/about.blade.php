						...
						<div class="row">
							...
							<div class="col-xl-4 col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="mb-4">
											<p class="mb-2">Web Designers<span class="float-left text-muted">80%</span></p>
											<div class="progress progress-sm mb-3">
												<div class="progress-bar progress-bar-striped progress-bar-animated bg-teal w-80"></div>
											</div>
										</div>
										<div class="mb-4">
											<p class="mb-2">App Designers<span class="float-left text-muted">46%</span></p>
											<div class="progress progress-sm mb-3">
												<div class="progress-bar progress-bar-striped progress-bar-animated bg-primary w-45"></div>
											</div>
										</div>
										<div class="mb-0">
											<p class="mb-2">Web Development<span class="float-left text-muted">76%</span></p>
