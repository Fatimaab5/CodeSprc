							...
							<div class="col-md-12 col-lg-4 col-md-4 col-xl-46">
								<div class="card card-blog-overlay ">
									<div class="card-header z-index-10 pb-0">
										...
										<div class="card-options">
											<a href="#" class="card-options-collapse ml-2 ml-2" data-toggle="card-collapse"><i class="fe fe-chevron-up text-white"></i></a>
							...
							<div class="col-md-12 col-xl-4 col-lg-4">
								<div class="card ">
									<div class="card-header ">
										...
										<div class="card-options">
											<a href="#" class="card-options-collapse ml-2 ml-2" data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
											<a href="#" class="card-options-remove" data-toggle="card-remove"><i class="fe fe-x "></i></a>
										</div>
									</div>
