						...
						<div class="row row-cards">
								...
								<div class="card card-aside">
									...
									<div class="card-body flex-column">
										<div class="d-flex align-items-center mb-5">
											<div><img class="avatar brround avatar-md ml-3" src="{{URL::asset('assets/images/users/male/6.jpg')}}" alt="img"></div>
											<div>
							...
							<div class="col-lg-6">
								<div class="card card-aside">
									<div class="card-body flex-column">
										<div class="d-flex align-items-center mb-5">
											<div class="avatar  brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/male/16.jpg')}}"></div>
											<div>
								...
								<div class="card card-aside">
									...
									<div class="card-body flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar  brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/female/18.jpg')}}"></div>
											<div>
							...
							<div class="col-lg-6">
								<div class="card card-aside">
									<div class="card-body flex-column">
										...
										<div class="text-muted">Many desktop publishing packages and web page editors now use  default model text, and a search for will uncover...</div>
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar  brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/male/3.jpg')}}"></div>
											<div>
												<a href="{{url('profile')}}" class="text-default font-weight-semibold">Irene	Scott</a>
												<small class="d-block text-muted">2 days ago</small>
											</div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="card">
									<div class="card-body d-flex flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar  brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/male/26.jpg')}}"></div>
											<div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="card">
									<div class="card-body d-flex flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/female/7.jpg')}}"></div>
											<div>
						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center pb-5 mt-auto">
											<div><img src="{{URL::asset('assets/images/users/female/8.jpg')}}" alt="img" class="avatar brround avatar-md ml-3"></div>
											<div>
							...
							<div class="col-sm-6 col-xl-4">
								<div class="card">
									...
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center pb-5 mt-auto">
											<div><img class="avatar brround avatar-md ml-3" src="{{URL::asset('assets/images/users/male/18.jpg')}}" alt="img"></div>
											<div>
							...
							<div class="col-sm-6 col-xl-4">
								<div class="card">
									...
									<div class="card-body d-flex flex-column">
										<div class="d-flex align-items-center pb-5 mt-auto">
											<div><img class="avatar brround avatar-md ml-3" src="{{URL::asset('assets/images/users/male/17.jpg')}}" alt="img"></div>
											<div>
