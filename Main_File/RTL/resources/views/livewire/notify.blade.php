...
@section('styles')
	...
	<!-- Notifications  css -->
	<link href="{{URL::asset('assets/plugins/notify-growl/css/jquery.growl-rtl.css')}}" rel="stylesheet" />
	<link href="{{URL::asset('assets/plugins/notify-growl/css/notifIt-rtl.css')}}" rel="stylesheet" />
...
@section('scripts')
		...
		<script src="{{URL::asset('assets/plugins/notify-growl/js/sample-rtl.js')}}"></script>
