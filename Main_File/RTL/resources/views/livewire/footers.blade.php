...
@section('content')
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<div class="">
										<div class="footer br-bl-7 br-br-7">
											<div class="container">
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-header pb-0">
										<div class="card-title">Footer style05</div>
									</div>
									<div class="card-body">
										...
										<footer class="main-footer pl-0 pr-0">
											<div class="row">
												<div class="col-xl-8 col-lg-12 col-md-12 footer1">
													Copyright &copy;Sparic 2021. Design By<a href="https://spruko.com/"> Spruko</a>
												</div>
												<div class="col-xl-4 col-lg-12 col-md-12 ml-auto text-left">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header pb-0">
										<div class="card-title">Footer style06</div>
									</div>
									<div class="card-body">
										<div class="top-footer">
											<div class="row">
												...
												<div class="col-lg-4 col-md-12">
													<h6>Posts</h6>
													<img alt="" src="{{URL::asset('assets/images/photos/media1.jpg')}}">
													<img alt="" src="{{URL::asset('assets/images/photos/media2.jpg')}}">
													<img alt="" src="{{URL::asset('assets/images/photos/media3.jpg')}}">
													<img alt="" src="{{URL::asset('assets/images/photos/media4.jpg')}}">
													<hr>
