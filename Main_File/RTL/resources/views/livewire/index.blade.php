								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-4">
												<img src="{{URL::asset('assets/images/svg/chart.svg')}}" alt="imag" class="w-40 h-100 text-right float-left">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-4">
												<img src="{{URL::asset('assets/images/svg/businessman.svg')}}" alt="imag" class="w-40 h-100 text-right float-left">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-4">
												<img src="{{URL::asset('assets/images/svg/list.svg')}}" alt="imag" class="w-40 h-100 text-right float-left">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-4">
												<img src="{{URL::asset('assets/images/svg/investment.svg')}}" alt="imag" class="w-40 h-100 text-right float-left">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xxl-7 col-lg-12 col-md-12">
											...
											<div class="card-body iconfont">
												<div class="row">
													<div class="col">
														...
														<p class="text-muted"><span class="text-body font-weight-semibold"><i class="fa fa-arrow-up text-success ml-1"> </i>23% </span> in this year</p>
													</div>
											...
											<div class="card-body iconfont">
												<div class="row">
													<div class="col">
														...
														<p class="text-muted"><span class="text-body font-weight-semibold"><i class="fa fa-arrow-up text-success ml-1"> </i>13% </span> in this year</p>
													</div>
													<div class="col col-auto feature">
											...
											<div class="card-body iconfont">
												<div class="row">
													<div class="col">
														...
														<p class="text-muted"><span class="text-body font-weight-semibold"><i class="fa fa-arrow-down text-danger ml-1"> </i>12%</span> in this year</p>
													</div>
													<div class="col col-auto feature">
								...
								<div class="card overflow-hidden d-inline-block">
									<div class="card-header custom-header pb-0">
										...
										<div class="card-options">
											<a href="" class="ml-4 text-default" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">
												<span class="fa fa-ellipsis-v"></span>
											</a>
											<ul class="dropdown-menu dropdown-menu-left" role="menu">
												<li><a href="#">Add<i class="si si-plus ml-2"></i></a></li>
												<li><a href="#">Remove<i class="si si-trash ml-2"></i></a></li>
												<li><a href="#">View<i class="si si-eye ml-2"></i></a></li>
												<li><a href="#">More<i class="si si-settings ml-2"></i></a></li>
											</ul>
										</div>
									</div>
									<div class="card-body">
							...
							<div class="col-xxl-6 col-xl-12 col-lg-12">
								<div class="card d-inline-block overflow-hidden">
									...
									<div class="card-body overflow-hidden">
										...
										<p class="text-muted"> If You want See More locations of any country first login to <a href="">Sparic.in</a> and find More locations. And  add More locations.It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
									</div>
								</div>
							</div>
										...
										<div class="list-group list-lg-group list-group-flush">
											<a class="list-group-item list-group-item-action" href="#">
												<div class="media mt-0">
													<img class="avatar-xxl rounded-circle ml-3" src="{{URL::asset('assets/images/users/female/2.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-3">
																Samantha Wilson
															</h4>
															<small class="text-primary mr-md-auto"><i class="fe fe-calendar mr-1"></i> 28 Feb 2019</small>
														</div>
											...
											<a class="list-group-item list-group-item-action" href="#">
												<div class="media mt-0">
													<img class="avatar-xxl rounded-circle ml-3" src="{{URL::asset('assets/images/users/male/2.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-3">
																Kevin North
															</h4>
															<small class="text-primary mr-md-auto"><i class="fe fe-calendar mr-1"></i> 26 Feb 2019</small>
														</div>
														<p class="mb-0 text-muted">Itaque earum rerum hic tenetur a sapiente reiciendis voluptatibus.</p>
													</div>
												</div>
											...
											<a class="list-group-item list-group-item-action" href="#">
												<div class="media mt-0">
													<img class="avatar-xxl rounded-circle ml-3" src="{{URL::asset('assets/images/users/male/12.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-3">
																Steven Fisher
											...
											<a class="list-group-item list-group-item-action br-br-7 br-bl-7" href="#">
												<div class="media mt-0">
													<img class="avatar-xxl rounded-circle ml-3" src="{{URL::asset('assets/images/users/female/5.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-md-flex align-items-center">
															<h4 class="mb-3">
																Joanne Taylor
															</h4>
															<small class="text-primary mr-md-auto"><i class="fe fe-calendar mr-1"></i> 25 Feb 2019</small>
														</div>
														<p class="mb-0 text-muted">Itaque earum rerum hic tenetur a sapiente reiciendis voluptatibus.</p>
													</div>
												</div>
...
@section('scripts')
		...
		<!-- ApexChart -->
		<script src="{{URL::asset('assets/plugins/apexcharts-rtl/apexcharts-rtl.js')}}"></script>
