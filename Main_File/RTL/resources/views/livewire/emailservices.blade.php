								...
								<div class="card">
									<div class="list-group list-group-transparent mb-0 mail-inbox">
										...
										<a href="{{url('emailservices')}}" class="list-group-item list-group-item-action d-flex align-items-center active">
											<span class="icon ml-3"><i class="fe fe-inbox"></i></span>Inbox <span class="mr-auto badge badge-success">14</span>
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fe fe-send"></i></span>Sent Mail
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fe fe-alert-circle"></i></span>Important <span class="mr-auto badge badge-danger">3</span>
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fe fe-star"></i></span>Starred
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fe fe-file"></i></span>Drafts
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fe fe-tag"></i></span>Tags
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fe fe-trash-2"></i></span>Trash
										</a>
									</div>
								</div>
								<div class="card">
							...
							<div class="col-lg-8 col-md-12 col-sm-12">
								<div class="card">
									<div class="inbox card-body">
										...
										<div class="row">
											<div class="col-sm-10 mr-auto col-md-12 col-lg-10">
