								...
								<div class="inbox p-0">
									<div class="card-body">
										...
										<div class="toolbar d-none d-lg-block">
											...
											<div class="btn-group float-left mt-3">
									 ...
									 <ul class="mail_list list-group list-unstyled">
											...
											<div class="media">
												...
												<div class="media-body">
													<div class="media-heading">
														<a href="#" class="ml-2">Velit a labore</a>
														<small class="float-left text-muted"><time class="hidden-sm-down" datetime="2017">12:35 AM</time><i class="fa fa-paperclip mr-2"></i> </small>
													</div>
										...
										<li class="list-group-item unread">
											<div class="media">
												...
												<div class="media-body">
													<div class="media-heading">
														<a href="#" class="ml-2">Simply dummy text</a>
														<small class="float-left text-muted"><time class="hidden-sm-down" datetime="2017">12:35 AM</time><i class="fa fa-paperclip mr-2"></i> </small>
													</div>
										...
										<li class="list-group-item unread">
											<div class="media">
												...
												<div class="media-body">
													<div class="media-heading">
														<a href="#" class="ml-2">Variations of passages</a>
										...
										<li class="list-group-item">
											<div class="media">
												...
												<div class="media-body">
													<div class="media-heading">
														<a href="#" class="ml-2">Generators on the Internet</a>
										...
										<li class="list-group-item">
											<div class="media">
												...
												<div class="media-body">
													<div class="media-heading">
														<a href="#" class="ml-2">Contrary to popular</a>
